...
\begin{enumerate}
  ...
  \item The layout of the arena is given in
        \hyperref[fig:arena]{Figure~\ref*{fig:arena}}.
  ...
  \item Each wall of the arena features seven \SI{250}{mm} fiducial markers.
        ...
        \hyperref[fig:sidewall]{Figure~\ref*{fig:sidewall}}.
...
\begin{enumerate}
  ...
  \item The initial layout of tokens in the arena is defined in
        \hyperref[spec:tokenpos]{Specification~\ref*{spec:arena}.\ref*{spec:tokenpos}}.
\end{enumerate}
