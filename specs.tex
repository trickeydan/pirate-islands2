...
The arena and tokens in the game are labelled with \emph{AprilTag} fiducial
...
\begin{enumerate}
  ...
  \item In the arena there are 4 square columns with a height greater than or equal to \SI{300}{mm}, and a width of \SI{300}{mm}.
  \item Podiums will have 4 different markers on each face, as given in Figure~\ref{fig:arena}.
...
\begin{enumerate}
  ...
  \item Each face of each token has a paper AprilTag marker attached. The marker is
        identical on all six faces.
  \item The initial layout of tokens in the arena is defined in Section
